...
class Version20140915132715 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $accessToken->addColumn('id', 'integer')->setNotNull(true);
        ...
        $authCode->addColumn('id', 'integer')->setNotNull(true);
        ...
        $client->addColumn('id', 'integer')->setNotNull(true);
        ...
        $refreshToken->addColumn('id', 'integer')->setNotNull(true);
        ...
        $users->addColumn('id', 'integer')->setNotNull(true);
