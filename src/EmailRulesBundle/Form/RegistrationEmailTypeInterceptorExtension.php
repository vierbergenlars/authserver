...
class RegistrationEmailTypeInterceptorExtension extends AbstractTypeExtension
{
    /**
    ...
    {
        $builder->get('emailAddresses')->addEventSubscriber($this->emailValidationSubscriber);
    }
