...
use OAuthBundle\Entity\AuthorizationCode;
...
class AuthorizationCodeStorage implements AuthorizationCodeInterface
{
    ...
    {
        // Get Code
        $code = $this->em->getRepository('OAuthBundle:AuthorizationCode')->find($code);
    ...
    {
        $client = $this->em->getRepository('AppBundle:OAuth\\Client')->find($client_id);
